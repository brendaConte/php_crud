            ...
            <div class="col-12 col-md-6">
                <div class="card card-detail" >
                    <div class="card-body card-detail-body">
                        <img src="/uploads/images/<?php echo $entradas->imagen; ?>" style="height: 150px;width: 100%;">
                       ...
                       <div class="card-link card-detail-links row">
                            <a  href="<?php echo base_url('EntradasController') ?>" class="card-link col">Volver</a>
